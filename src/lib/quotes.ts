...
const MORNING: Quote[] = [
  ...
  {
    text: "Les champions ne se font pas dans les salles de sport — ils se font avec quelque chose qu'ils ont au fond d'eux.",
    author: "Muhammad Ali",
  },
];
...
const NIGHT: Quote[] = [
  ...
  {
    text: "Le repos fait partie de l'entraînement. Demain, tu reviens plus fort.",
    author: "Anonyme",
  },
  {
    text: "La nuit porte conseil — et les muscles poussent pendant le sommeil.",
    author: "Anonyme",
  },
