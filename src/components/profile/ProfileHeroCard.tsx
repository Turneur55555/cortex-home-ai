 ...
 * le nom de rang (« TITAN ») domine en lettrage serif. Aucun grade, ni
 * progression, ni XP, ni tableau de bord : le rang est l'unique information
 * textuelle. La carte représente uniquement le personnage.
 *
...
export function ProfileHeroCard({
  ...
  return (
    <motion.header
      ...
      className="relative mb-6 overflow-hidden rounded-[28px] px-5 pb-7 pt-4 shadow-elevated"
      style={{
