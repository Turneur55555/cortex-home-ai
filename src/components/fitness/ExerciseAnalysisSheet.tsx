            ...
            {sessionCount > 0 ? (
              <>
                ...
                <div className="grid grid-cols-3 gap-2">
                  ...
                  {avg30 != null && (
                    <StatTileMini label="Moy. 30j" value={`${avg30.toFixed(1)} ${unit}`} />
                  )}
                  {progression != null && (
                    <StatTileMini
                      icon={
                    ...
                    {analysis.imbalances.length === 0 ? (
                      ...
                      <div className="space-y-2.5">
                        {analysis.imbalances.map((im, i) => (
                          <div
                            key={i}
                            className={`rounded-xl border-l-2 bg-surface p-3 ${im.severity === "alert" ? "border-destructive" : im.severity === "warning" ? "border-warning" : "border-primary"}`}
                          >
