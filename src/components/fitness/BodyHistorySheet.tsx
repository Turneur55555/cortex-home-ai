  ...
  return (
    <Portal>
      ...
      >
                    ...
                    >
                      <div className="mb-2 flex items-center justify-between gap-2">
                        <div>
                          ...
                          <p className="text-[10px] text-muted-foreground">Enregistré à {time}</p>
                        </div>
        ...
        {editing && <EditMeasurementSheet row={editing} onClose={() => setEditing(null)} />}
        ...
        {confirmId && (
          ...
          >
            ...
            >
              ...
              <p className="mb-4 text-xs text-muted-foreground">Cette action est irréversible.</p>
