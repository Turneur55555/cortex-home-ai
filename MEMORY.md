...
- Bug potentiel signalé (non corrigé, hors périmètre) : `PROFILE_BASE_QK` dans `useProfile.ts` — le commentaire dit qu'il doit vider le cache profil au logout, mais aucun code ne le fait.
