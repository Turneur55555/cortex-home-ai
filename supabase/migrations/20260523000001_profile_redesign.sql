...
-- Goals (Supabase-backed) + Badge Catalog + user_badges enhancements
-- ============================================================

-- 1. GOALS TABLE (Supabase-backed, replaces localStorage)
...
-- 2. BADGES CATALOG (reference table — all users can read)
...
-- 3. ENHANCE user_badges with rarity, xp_reward, description
ALTER TABLE public.user_badges ADD COLUMN IF NOT EXISTS rarity      text    NOT NULL DEFAULT 'common';
ALTER TABLE public.user_badges ADD COLUMN IF NOT EXISTS xp_reward   integer NOT NULL DEFAULT 50;
ALTER TABLE public.user_badges ADD COLUMN IF NOT EXISTS description text    NOT NULL DEFAULT '';
