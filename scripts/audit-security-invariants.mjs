...
const INVARIANTS = [
  ...
  },
  {
    ...
    description:
      "activity_log n'a plus de policy ALL/SELECT permissive triviale pour authenticated",
    sql: `select count(*)::int as n from pg_policies
  ...
  },
  {
    ...
    description:
      "disciplines/reward_catalog/exercise_families/exercise_media non lisibles par anon",
  ...
  },
  {
    ...
    description:
      "exercise_reference : aucune écriture cliente (3 RESTRICTIVE, 0 policy write permissive)",
    sql: `select
